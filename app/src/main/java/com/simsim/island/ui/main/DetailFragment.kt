...
//        adapter= DetailRecyclerViewAdapter(this,args.poId){}
...
//        actionMode.title=args.ThreadId
//        return binding.root
//    }
//
...
//            add( R.id.nv_host_fragment_container,NewDraftFragment.newInstance(target = "thread",targetKeyWord =args.ThreadId),"reply")
